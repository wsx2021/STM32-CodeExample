...
#endif
  //ADI_Print("Note: Current Silicon is %s\n", bIsS2silicon?"S2":"S1"); @anna commented this out for labview purposes
  //ADI_Print("AD5940LIB Version:v%d.%d.%d\n", AD5940LIB_VER_MAJOR, AD5940LIB_VER_MINOR, AD5940LIB_VER_PATCH); @anna commented this out for labview purposes
#endif
}
